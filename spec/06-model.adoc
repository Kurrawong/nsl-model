...
| https://www.w3.org/TR/skos-reference/#scopeNote[Scope Note] | This is schema.org's general _citation_ predicate which is a looser form of <<CITO, CITO>>'s `<<cito:cites>>`. The NSL model will use this predicate as a shortcut between citing and cited resources
| https://www.w3.org/TR/skos-reference/#example[Example]
a| [source,turtle]
----
PREFIX bibo: <http://purl.org/ontology/bibo/>
