...
<https://www.biodiversitylibrary.org/page/34948210>
    a nsl:Usage ;
    biro:references <https://id.biodiversity.org.au/name/afd/87296> ;  # TaxonName
    biro:references <http://hdl.handle.net/102.100.100/314652> ;  # CreativeWork
    # ... other properties situating the usage
.
----
|===
...
| Definition | A bibliographic reference is a realization of a bibliographic record. Moreover, it can contain only items referring to elements contained by the bibliographic record it realizes.
| Is Defined By | http://www.sparontologies.net/ontologies/biro[Bibliographic Reference Ontology (BiRO]
| Provenance | Defined by the NSL team
| Subclass of | Used without alteration
| Expected Properties |
| Example
a| [source,turtle]
----
...
| Provenance | Used without alteration
